...
export default function ImprintPage() {
    return (
        <>
            ...
            <h5 className="pt-3">Aufsichtsbehörde</h5>
            <p>...</p>

            <h5 className="pt-3">Verantwortlich für den Inhalt nach § 18 Abs. 2 MStV</h5>
            <p>
                Tristan Cebulla<br/>
                Hintergasse 5a<br/>
                55606 Oberhausen
            ...
            <h5 className="pt-3">Verbraucherstreitbeilegung / Universalschlichtungsstelle</h5>
            <p>Ich nehme nicht an Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teil und bin dazu
                auch nicht verpflichtet.</p>

            <h5 className="pt-3">Datenschutzerklärung</h5>
            <p>gibt's hier...</p>

            <h4 className="pt-3">Haftungsausschluss</h4>
            ...
            <p>Die Inhalte unserer Seiten wurden mit größter Sorgfalt erstellt. Für die Richtigkeit, Vollständigkeit und
                ...
                bis 10 DDG sind wir als Diensteanbieter jedoch nicht verpflichtet, übermittelte oder gespeicherte fremde
